...
import '../components/HeroPage.scss'
  ...
  return (
    <section className='hero'>
        <div className="wrap hero__top">
            <div>
                <div className="eyebrow">
                    Ноутбуки Dell · Осенняя линейка
                </div>
                <h1>
                    Техника, которая работает на вас.
                </h1>
                <div className="lede">
                    XPS, Inspiron и Alienware — от лёгких ультрабуков для офиса до мощных станций для игр и работы с графикой. Оригинальная гарантия Dell по всему миру.
                </div>
            ...
            <div className="specsheet">
                ...
                <a className="btn btn-primary btn-sm" href="https://www.dell.com" target="_blank">
                    Открыть на Dell.com
                    </a>
                </div>
            </div>
        ...
        <div className="hero__strip">
            <div className="wrap">
                <span><strong>30 дней</strong> на возврат</span>
                <span><strong>1–3 года</strong> гарантии производителя</span>
                <span><strong>24/7</strong> техническая поддержка</span>
                <span><strong>Рассрочка</strong> при оформлении на сайте</span>
            </div>
        </div>
    </section>
  )
